...
Version  : 1.8.4
Release  : 14
URL      : https://github.com/alembic/alembic/archive/1.8.4/alembic-1.8.4.tar.gz
Source0  : https://github.com/alembic/alembic/archive/1.8.4/alembic-1.8.4.tar.gz
...
%prep
%setup -q -n alembic-1.8.4
cd %{_builddir}/alembic-1.8.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672201097
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/alembic-%{version}/LICENSE.txt %{buildroot}/usr/share/package-licenses/scene-alembic/0cfaafe307c2d681b44f591aee85efa1bd8c636a
pushd clr-build
%make_install
popd
...
/usr/lib64/libAlembic.so.1.8.4

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/scene-alembic/0cfaafe307c2d681b44f591aee85efa1bd8c636a
