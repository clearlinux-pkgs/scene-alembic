...
Version  : 1.8.1
Release  : 8
URL      : https://github.com/alembic/alembic/archive/1.8.1/alembic-1.8.1.tar.gz
Source0  : https://github.com/alembic/alembic/archive/1.8.1/alembic-1.8.1.tar.gz
...
%prep
%setup -q -n alembic-1.8.1
cd %{_builddir}/alembic-1.8.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622076952
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/alembic-1.8.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/scene-alembic/0cfaafe307c2d681b44f591aee85efa1bd8c636a
pushd clr-build
%make_install
popd
