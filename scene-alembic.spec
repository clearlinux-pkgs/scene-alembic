...
Version  : 1.8.2
Release  : 9
URL      : https://github.com/alembic/alembic/archive/1.8.2/alembic-1.8.2.tar.gz
Source0  : https://github.com/alembic/alembic/archive/1.8.2/alembic-1.8.2.tar.gz
...
%prep
%setup -q -n alembic-1.8.2
cd %{_builddir}/alembic-1.8.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624044247
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/alembic-1.8.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/scene-alembic/0cfaafe307c2d681b44f591aee85efa1bd8c636a
pushd clr-build
%make_install
popd
